...
namespace DestroyerTest.Common
{
	...
	public abstract class ModTownEmote : ModEmoteBubble
	{
		...
		public override string Texture => "DestroyerTest/Common/NPCEmotes";
	...
	public class ProspectorEmote : ModTownEmote
	{
	...
	public class VampireEmote : ModTownEmote
	{
		public override int Row => 1;
	}

	public class UntitledEmote : ModTownEmote
    // Will something come of this? You'll never know...
	{
