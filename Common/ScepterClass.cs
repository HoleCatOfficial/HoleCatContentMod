...
{
	public class ScepterClass : DamageClass
	{
        ...
        // REMOVE GETEFFECTINHERITANCE LATER ONCE THE CLASS IS FULLY FLESHED OUT
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<ScepterClass>() += 4;
            player.GetAttackSpeed<ScepterClass>() += 01f;
			player.GetArmorPenetration<ScepterClass>() += 2;
