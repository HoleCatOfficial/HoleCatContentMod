...
namespace DestroyerTest.Common.Systems
{
	...
	public class EnchantedScepterChestLoot : ModSystem
	{
		...
		public override void PostWorldGen()
		{
			...
			int[] itemsToPlaceInDungeonChests = { ModContent.ItemType<EnchantedScepter>() };
	...
	public class ShadowScepterChestLoot : ModSystem
	{
		// We use PostWorldGen for this because we want to ensure that all chests have been placed before adding items.
		public override void PostWorldGen()
		{
			// Place some additional items in Frozen Chests:
			// These are the 3 new items we will place.
			int[] itemsToPlaceInDungeonChests = { ModContent.ItemType<ShadowScepter>() };
			// This variable will help cycle through the items so that different Frozen Chests get different items
			int itemsToPlaceInDungeonChestsChoice = 0;
			// Rather than place items in each chest, we'll place up to 6 items (2 of each). 
			int itemsPlaced = 0;
	...
	public class SkyChestLoot : ModSystem
	{
		...
		public override void PostWorldGen() {
			// Place some additional items in Frozen Chests:
			// These are the 3 new items we will place.
			int[] itemsToPlaceInDungeonChests = { ModContent.ItemType<TurbulenceScroll>(), ModContent.ItemType<StarScroll>() };
			// This variable will help cycle through the items so that different Frozen Chests get different items
			int itemsToPlaceInDungeonChestsChoice = 0;
			// Rather than place items in each chest, we'll place up to 6 items (2 of each). 
			int itemsPlaced = 0;
