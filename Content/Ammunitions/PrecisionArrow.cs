...
namespace DestroyerTest.Content.Ammunitions
{
	...
	public class PrecisionArrow : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<PrecisionArrowProjectile>(); // The projectile that weapons fire when using this item as ammunition.
