	...
	public class TenebrousDemon : ModPlayer
	{
		...
		public void ChargeEffects()
		{
			if (Charge1)
			{
                ...
                {
                    ElectricArc Arc = new();
                    Arc.Create(Main.rand.NextVector2FromRectangle(Player.Hitbox), ColorLib.TenebrisGradient, Main.rand.NextFloat(0.5f, 1f), 0.5f);
			...
			if (Charge2)
			{
                ...
                {
                    ElectricArc Arc = new();
                    Arc.Create(Main.rand.NextVector2FromRectangle(Player.Hitbox), ColorLib.TenebrisGradient, Main.rand.NextFloat(0.5f, 1f), 0.75f);
                    ParticleEngine.ShaderParticles.Add(Arc);
                }
			}
			if (Charge3)
			{
                ...
                {
                    ElectricArc Arc = new();
                    Arc.Create(Main.rand.NextVector2FromRectangle(Player.Hitbox), ColorLib.TenebrisGradient, Main.rand.NextFloat(0.5f, 1f), 1f);
                    ParticleEngine.ShaderParticles.Add(Arc);
                }
				if (ComboCounter >= 120)
				{
