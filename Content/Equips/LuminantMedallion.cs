...
namespace DestroyerTest.Content.Equips
{
    ...
    public class LuminantMedallionOwnedProjectiles : GlobalProjectile
    {
        ...
        public override void OnHitNPC(Projectile projectile, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                if ((projectile.DamageType == DamageClass.Summon && projectile.DamageType != DamageClass.Generic) && Main.rand.NextBool((int)(16 * (1 + (0.1f * Main.player[projectile.owner].numMinions)))))
                {
