...
namespace DestroyerTest.Content.Equips.AetherianSet
{
    ...
    public class AetherianRegalia : ModItem
    {
        ...
        public static readonly float SpeedBonus = 1.06f;
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs((SpeedBonus - 1f).ToString("P1"));
        ...
        {
			CreateRecipe()
				.AddIngredient(ItemID.ShimmerBlock, 16)
