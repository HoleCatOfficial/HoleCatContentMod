...
{
    public class MalevolenceMantra : ModItem
    {
        ...
        {
            if (player.TryGetModPlayer<MMScepterUsePlayer>(out MMScepterUsePlayer Scptr))
			{
				Scptr.Active = true;
			}
        }
    ...
    public class MMScepterUsePlayer : ModPlayer
	{
