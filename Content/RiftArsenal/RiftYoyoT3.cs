...
{
	public class RiftYoyoT3 : ModItem, IRechargeFunctionality
    {
		...
		public override void SetDefaults() {
			...
			Item.damage = 100; // The amount of damage the item does to an enemy or player.
			...
			Item.rare = ModContent.RarityType<RiftRarity2>(); // The item's rarity. This changes the color of the item's name.
			Item.value = Item.buyPrice(gold: 1); // The amount of money that the item is can be bought for.

			Item.shoot = ModContent.ProjectileType<RiftYoyoT3Projectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
