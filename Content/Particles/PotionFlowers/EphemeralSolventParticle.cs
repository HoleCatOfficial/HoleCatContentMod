...
{
    public class EphemeralSolventParticle : BaseParticle<EphemeralSolventParticle>
    {
        ...
        {
            Texture2D Texture = TextureAssets.Item[ModContent.ItemType<EphemeralSolvent>()].Value;
