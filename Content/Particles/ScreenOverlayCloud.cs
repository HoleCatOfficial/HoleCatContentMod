...
namespace DestroyerTest.Content.Particles
{
    ...
    internal class ScreenOverlay : BasePRT
    {
        ...
        public override void SetProperty()
        {
            ...
            Scale = Main.rand.NextFloat(1.0f, 2.0f); // Random scale between 0.5 and 1.5.
        }
    ...
    internal class ScreenOverlayCloud1 : ScreenOverlay
    {

    }

    internal class ScreenOverlayCloud2 : ScreenOverlay
    {

    }

    internal class ScreenOverlayCloud3 : ScreenOverlay
    {

    }

    internal class ScreenOverlayCloud4 : ScreenOverlay
    {

    }

    internal class ScreenOverlayCloud5 : ScreenOverlay
    {

    }

    internal class ScreenOverlayCloud6 : ScreenOverlay
    {

    }
    
    internal class ScreenOverlayCloud7 : ScreenOverlay
    {
