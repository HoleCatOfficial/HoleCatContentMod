        ...
        public override bool PreDraw(ref Color lightColor)
            {
                ...
                Texture2D glowTexture = ModContent.Request<Texture2D>("DestroyerTest/Content/Particles/TenebrousBurstBoomAnim_500x500").Value;

                // Calculate the current frame based on the projectile's lifetime
                int totalFrames = 38; // Total number of frames in the animation
                int frameWidth = 500; // Width of each frame
                int frameHeight = 500; // Height of each frame
                int framesPerRow = 19; // Number of frames per row in the texture
