...
namespace DestroyerTest.Content.Particles.DamageBonusParticles
{
    ...
    internal class DamageBonusParticle : BasePRT
    {
        ...
        public override void SetProperty()
        {
            ...
            Scale = 1.0f; // Random scale between 0.5 and 1.5.
        }
        ...
        public override void AI()
        {
            ...
            Position -= new Vector2(0, Main.rand.NextFloat(0.1f, 0.8f));
    ...
    internal class MagicDamageBonus1 : DamageBonusParticle
    {

    }

    internal class MagicDamageBonus2 : DamageBonusParticle
    {

    }

    internal class MeleeDamageBonus : DamageBonusParticle
    {

    }

    internal class RangerDamageBonus1 : DamageBonusParticle
    {

    }

    internal class RangerDamageBonus2 : DamageBonusParticle
    {

    }

    internal class ScepterDamageBonus : DamageBonusParticle
    {

    }

    internal class SummonerDamageBonus : DamageBonusParticle
    {
