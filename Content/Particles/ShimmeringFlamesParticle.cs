...
namespace DestroyerTest.Content.Particles
{
    ...
    internal class BaseShimmeringFlames : BasePRT
    {
        ...
        public override void SetProperty()
        {
            ...
            Color = ColorLib.TenebrisGradient * 0.8f;
            Opacity *= 0.04f;
        ...
        public override void AI()
        {
            ...
            Velocity += new Vector2(Main.rand.NextFloat(-0.2f, 0.2f), 0f);
    ...
    internal class ShimmeringFlame1 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame2 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame3 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame4 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame5 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame6 : BaseShimmeringFlames
    {

    }
    internal class ShimmeringFlame7 : BaseShimmeringFlames
    {
