...
namespace DestroyerTest.Content.Particles.CurseRunes
{
    ...
    internal class Rune1 : BaseRune
    {

    }

    internal class Rune2 : BaseRune
    {

    }

    internal class Rune3 : BaseRune
    {
