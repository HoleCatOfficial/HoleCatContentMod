...
{
	public class RiftFlameDust : ModDust
	{
		public override string Texture => "DestroyerTest/Content/Projectiles/GlowParticle";
		public override void OnSpawn(Dust dust) {
			...
			dust.color = new Microsoft.Xna.Framework.Color (255, 155, 0);
		}
