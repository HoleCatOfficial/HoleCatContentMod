...
{
	public class BerylliumCopper : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tile_BerylliumCopper>());
			Item.width = 20;
			Item.height = 20;
		...
		public override void AddRecipes() {
			CreateRecipe()
                ...
                .AddIngredient<BerylliumOre>(2)
                .AddIngredient<NickelOre>(1)
