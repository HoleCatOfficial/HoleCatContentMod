...
{
	public class DamascusSteel : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tile_DamascusSteel>());
			Item.width = 30;
			Item.height = 24;
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient<TemperedSteel>(2)
				.AddIngredient<ZincOre>(1)
