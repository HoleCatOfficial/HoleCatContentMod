...
{
	public class TemperedBerylliumCopper : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tile_TemperedBerylliumCopper>());
			Item.width = 30;
			Item.height = 24;
		...
		public override void AddRecipes() {
			CreateRecipe()
                .AddIngredient<BerylliumCopper>(2)
