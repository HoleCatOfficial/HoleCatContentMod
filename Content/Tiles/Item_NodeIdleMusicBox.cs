...
{
	public class Item_NodeIdleMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NodeIdle"), ModContent.ItemType<Item_NodeIdleMusicBox>(), ModContent.TileType<Tile_NodeIdleMusicBox>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<Tile_NodeIdleMusicBox>(), 0);
		}
