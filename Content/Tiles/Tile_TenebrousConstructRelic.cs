...
{
    public class Tile_TenebrousConstructRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "DestroyerTest/Content/Tiles/Tile_NightmareRoseRelic";

        public override string Texture => "DestroyerTest/Content/Tiles/RelicPedestal";
