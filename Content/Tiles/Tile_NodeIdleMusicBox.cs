...
namespace DestroyerTest.Content.Tiles
{
	...
	public class Tile_NodeIdleMusicBox : ModTile
	{
		public override void SetStaticDefaults() {
			...
			AddMapEntry(new Color(239, 216, 112), Language.GetText("ItemName.MusicBox"));
		}
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<Item_NodeIdleMusicBox>();
		}
