...
{
    public class NeglectedRegardsDisplay : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(83, 80, 100), Language.GetText("Mods.DestroyerTest.Garden.FlowerPaperSwordMap"));
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            T.ClearTile();
            Item.NewItem(Item.GetSource_None(), Utils.CenteredRectangle(new Point(i, j).ToWorldCoordinates(), new Vector2(2f, 2f)), ModContent.ItemType<NeglectedRegards>());
        }
    }
}
