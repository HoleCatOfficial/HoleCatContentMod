...
{
	public class Item_NodeBossMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/NodeBoss"), ModContent.ItemType<Item_NodeBossMusicBox>(), ModContent.TileType<Tile_NodeBossMusicBox>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<Tile_NodeBossMusicBox>(), 0);
		}
