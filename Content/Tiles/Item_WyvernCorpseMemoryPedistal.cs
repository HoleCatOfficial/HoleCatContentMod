...
{
    public class Item_WyvernCorpseMemoryPedistal : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/WyvernSoulAmbience"), ModContent.ItemType<Item_WyvernCorpseMemoryPedistal>(), ModContent.TileType<Tile_MemoryPedistal>(), 36);
        }
        public override void SetDefaults()
        {
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<Tile_MemoryPedistal>(), 1);
        ...
        public override void AddRecipes()
        {
            ...
            {
                CreateRecipe()
                    .AddIngredient<WyvernCorpseArtifact>(6)
                    .Register();
            }
        }
    }
