...
{
	public class Item_RiftConfiguratorWeaponry : ModItem
	{
		public override void SetDefaults() {
            Item.DefaultToPlaceableTile(ModContent.TileType<Tile_RiftConfiguratorWeaponry>());
            Item.height = 44;
            Item.width = 38;
            Item.value = 6000;
            ...
            public override void RightClick(Player player)
            {
                  ...
                  Item.NewItem(player.GetSource_OpenItem(Type), player.position, ModContent.ItemType<WeaponryDrive>());
