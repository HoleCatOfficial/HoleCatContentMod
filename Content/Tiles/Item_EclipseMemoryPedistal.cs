...
{
    public class Item_EclipseMemoryPedistal : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SolarEclipse"), ModContent.ItemType<Item_EclipseMemoryPedistal>(), ModContent.TileType<Tile_MemoryPedistal>(), 72);
        }
        public override void SetDefaults()
        {
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<Tile_MemoryPedistal>(), 2);
