...
{
    public class Tile_CerebralChest : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AdjTiles = [TileID.Containers2];
            VanillaFallbackOnModDeletion = TileID.Containers2;
            ...
            AddMapEntry(new Color(200, 10, 214), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(56, 53, 49), this.GetLocalization("MapEntry1"), MapChestName);
            ...
            RegisterItemDrop(ModContent.ItemType<Item_CerebralChest>(), 1);
		...
		*/
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Item_CerebralChest>();
