...
{
	public class Item_SpecialTownMusicBoxNight : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SpecialTownMusicNight"), ModContent.ItemType<Item_SpecialTownMusicBoxNight>(), ModContent.TileType<Tile_SpecialTownMusicBoxNight>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<Tile_SpecialTownMusicBoxNight>(), 0);
		}
