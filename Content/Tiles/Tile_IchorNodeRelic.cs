...
{
	public class Tile_IchorNodeRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "DestroyerTest/Content/Tiles/Tile_IchorNodeRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "DestroyerTest/Content/Tiles/IchorNodeRelicPedestal";
