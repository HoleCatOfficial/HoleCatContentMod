...
{
	public class StellarFoxScepter : ModItem
	{
        ...
        public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<StellarPipeBomb>(); // The sword as a projectile
            Item.shootSpeed = 10f;
		...
		public override bool CanUseItem(Player player) {
			...
			if (player.altFunctionUse == 2) {
				...
				Item.shoot = ModContent.ProjectileType<StellarFoxScepterThrown>(); // The projectile is what makes a shortsword work
		...
		public override bool? UseItem(Player player)
		{
			if (player.altFunctionUse == 2) // Throwing mode
			{
				...
				foreach (Projectile proj in Main.projectile)
				{
					...
					if (proj.active && proj.owner == player.whoAmI && proj.type == ModContent.ProjectileType<StellarFoxScepterThrown>())
					{
						// Safely get the existenceTimer value
						if (proj.ModProjectile is StellarFoxScepterThrown thrownProj)
						{
