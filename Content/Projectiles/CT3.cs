...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class CT3_Swing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/SwordLineage/ConstitutionT3"; // Use texture of item as projectile texture
		...
		{
			Projectile.width = 114; // Hitbox width of projectile
			Projectile.height = 114; // Hitbox height of projectile
