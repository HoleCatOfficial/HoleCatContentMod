...
namespace DestroyerTest.Content.Projectiles.Gores
{
	public class RosePetalGore1 : ModGore
	{
		public override string Texture => "DestroyerTest/Content/Projectiles/Gores/RosePetalGore1";
