...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class SteelJavelinThrown : ModProjectile
	{
        public override string Texture => "DestroyerTest/Content/RogueItems/IronTier/SteelJavelin";
		...
		public override bool PreDraw(ref Color lightColor)
		{
            ...
            Vector2 offset = new Vector2(6.8f, 7.0f).RotatedBy(Projectile.rotation);
            Vector2 offsetpos = Projectile.Center + offset - Main.screenPosition;
