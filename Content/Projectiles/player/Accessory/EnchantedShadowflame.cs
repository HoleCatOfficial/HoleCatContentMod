...
{
    public class EnchantedShadowflame : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDust(Projectile.Center, 16, 16, DustID.Shadowflame, Projectile.velocity.X * 0.05f, Projectile.velocity.Y * 0.05f, 50, default, 0.75f);
            if (Main.rand.NextBool(5))
            {
                Dust.NewDust(Projectile.Center, 16, 16, DustID.Enchanted_Pink, Projectile.velocity.X * 0.05f, Projectile.velocity.Y * 0.05f, 50, default, 0.75f);
            }
