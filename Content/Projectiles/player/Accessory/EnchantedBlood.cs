...
{
    public class EnchantedBlood : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDust(Projectile.Center, 16, 16, DustID.LifeDrain, Projectile.velocity.X * 0.05f, Projectile.velocity.Y * 0.05f, 50, default, 0.75f);
