...
{
	public class TwistedFaithSwing : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
                ...
                Color clr1 = new Color(68, 45, 117);
                Color clr2 = new Color(211, 168, 223);
				Color dustColor = Color.Lerp(clr1, clr2, Main.rand.NextFloat() * 0.3f);
			...
			if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
				...
				Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, new Color(68, 45, 117) * Projectile.Opacity, 1.2f * Projectile.Opacity);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color backDarkColor = new Color(68, 45, 117); // Original Excalibur color: Color(180, 160, 60)
			Color middleMediumColor = new Color(144, 106, 173); // Original Excalibur color: Color(255, 255, 80)
			Color frontLightColor = new Color(211, 168, 223); // Original Excalibur color: Color(255, 240, 150)
