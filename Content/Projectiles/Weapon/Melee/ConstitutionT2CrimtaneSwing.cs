...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
	...
	public class ConstitutionT2CrimtaneSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/SwordLineage/ConstitutionT2_Crimtane";
        public override string GlowTexture => "DestroyerTest/Content/MeleeWeapons/SwordLineage/ConstitutionT2_Crimtane_Highlight";
		...
		public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D Trailtexture = ModContent.Request<Texture2D>("DestroyerTest/Content/Extras/ConstitutionT2Outline").Value;
            Texture2D BlurTexture = ModContent.Request<Texture2D>("DestroyerTest/Content/Particles/CircularSmear").Value;
            ...
            Main.EntitySpriteDraw(Trailtexture, Projectile.Center - Main.screenPosition, default,  ColorLib.StellarFireGradientLooping() * Projectile.Opacity, Projectile.rotation + rotationOffset, origin, Projectile.scale, effects, 0);
            ...
            Main.EntitySpriteDraw(BlurTexture, player.MountedCenter, null, Color.Red, Projectile.rotation + rotationOffset, player.MountedCenter, Projectile.scale * 0.2f, effects, 0);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Vector2 ToCursor = player.Center - Main.MouseWorld;
            ...
            if (hit.Crit)
            {
                ...
                {
                    float t = (float)i / (numberProjectiles + 1); // Evenly spaced intervals
                    Vector2 spawnPos = OffsetCenter + direction * DistanceOut * t;
                    Projectile FleshGround = Projectile.NewProjectileDirect(
                    Projectile.GetSource_OnHit(target),
                    spawnPos,
                    Projectile.rotation.ToRotationVector2() * 3f,
                    ProjectileID.HoundiusShootiusFireball, // Replace with your projectile type
                    (int)(Projectile.damage * 0.75f),
                    Projectile.knockBack,
                    player.whoAmI
                    );
                    FleshGround.penetrate = 2;
                    FleshGround.friendly = true;
                    FleshGround.hostile = false;
                }
            }
            ...
            Projectile.NewProjectile(
                Projectile.GetSource_OnHit(target),
                player.Center,
                Projectile.rotation.ToRotationVector2() * 5f,
                ProjectileID.SuperStarSlash, // Replace with your projectile type
                (int)(Projectile.damage * 0.75f),
                Projectile.knockBack,
                player.whoAmI
                );
