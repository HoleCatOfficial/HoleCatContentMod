...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
	...
	public class ConstitutionT2DemoniteSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/SwordLineage/ConstitutionT2_Demonite";
        public override string GlowTexture => "DestroyerTest/Content/MeleeWeapons/SwordLineage/ConstitutionT2_Demonite_Highlight";
		...
		public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(BlurTexture, player.MountedCenter, null, Color.Purple, Projectile.rotation + rotationOffset, player.MountedCenter, Projectile.scale * 2, effects, 0);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Vector2 posOffset = new Vector2(-8, 0);
            ...
            if (hit.Crit)
            {
                for (int i = 1; i <= numberProjectiles; i++)
                {
                    ...
                    Projectile CorruptGround = Projectile.NewProjectileDirect(
