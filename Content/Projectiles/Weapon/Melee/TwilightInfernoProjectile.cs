...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
	...
	public class TwilightInfernoProjectile : ModProjectile
	{
        public SoundStyle Swing = new SoundStyle("DestroyerTest/Assets/Audio/DarkGreatSword/Slice", 3);
		private const float SWINGRANGE = 1.67f * (float)Math.PI; 
		private const float FIRSTHALFSWING = 0.45f;
		private const float WINDUP = 0.09f;
		private const float UNWIND = 0.8f;
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TwistedLineage/TwilightInferno";
        ...
        private void ExecuteStrike()
		{
            ...
            if (!Sound1)
            {
                ...
                Projectile.NewProjectile(Entity.GetSource_FromThis(), Owner.Center, new Vector2(Main.rand.Next(5, 10) * Owner.direction, Main.rand.Next(-8, -2)), ModContent.ProjectileType<DarkFireball>(), Projectile.damage / 3, 5f, Projectile.owner);
                Sound1 = true;
            }
