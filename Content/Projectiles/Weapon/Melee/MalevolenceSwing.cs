    ...
    public class MalevolenceSwing : BaseBroadswordProjectile
    {
        ...
        public override void ExtraEffects()
        {
            ...
            if (CurrentState == State.SwingDown)
            {
                if (SwordLine != null)
                {
                    PRTLoader.NewParticle(PRTLoader.GetParticleID<SparkParticleNoGravity>(), swordTip, new Vector2(1, 0).RotatedBy(SwordLine.GetLineRotation + MathHelper.PiOver2), ColorLib.Wretched3, 1f, ai1: 2);
                }
            }
