...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
	...
	internal class GlacialJabberSwingProjectile : ModProjectile
	{
        ...
        ChainTexture = ModContent.Request<Texture2D>("DestroyerTest/Content/Extras/IceRope");
        }
		...
		public override bool PreDraw(ref Color lightColor) {
			Projectile.type = ModContent.ProjectileType<GlacialJabberSwingProjectile>();
