...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
    ...
    public class TwilightInfernoSwing : BaseBroadswordProjectile
    {
        ...
        public override void HitNPCEffects(NPC npc, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (hit.Crit)
            {
                Projectile.NewProjectile(Projectile.GetSource_OnHit(npc), npc.Center, Vector2.Zero, ModContent.ProjectileType<ShadowExplosion>(), Projectile.damage, 10, Owner.whoAmI);
            }
        }
        ...
        public override void OnStartSwing()
        {
            ...
            tocur.Normalize();
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), Owner.Center, tocur * (8 + Owner.GetTotalAttackSpeed(DamageClass.Melee)), ModContent.ProjectileType<DarkFireSpirit>(), (int)(Projectile.damage * 0.6f), 6, Owner.whoAmI);
        }
