...
namespace DestroyerTest.Content.Projectiles.Weapon.Melee
{
    public class ConstantineScytheMinionProjectile : ModProjectile
    {
		...
		{
			Texture2D segmentTex = ModContent.Request<Texture2D>("DestroyerTest/Content/Projectiles/Weapon/Melee/ConstantineScytheString").Value;
			Texture2D beadTex = ModContent.Request<Texture2D>("DestroyerTest/Content/Projectiles/Weapon/Melee/ConstantineScytheBead").Value;
