...
namespace DestroyerTest.Content.Projectiles.Weapon.Rogue
{
    public class HestiasBaneThrown : ModProjectile, IHomingProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(DTAssetLib.CircularSwingThin.Value, Projectile.Center - Main.screenPosition, null, ColorLib.TenebrisMagenta, ROff, DTAssetLib.CircularSwingThin.Value.Size() / 2, 0.5f, SpriteEffects.None, 0);
