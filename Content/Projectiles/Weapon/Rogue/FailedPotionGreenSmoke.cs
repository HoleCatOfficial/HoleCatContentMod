...
namespace DestroyerTest.Content.Projectiles.Weapon.Rogue
{
    public class FailedPotionGreenSmoke : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //PRTLoader.NewParticle(PRTLoader.GetParticleID<SimpleParticle>(), Main.rand.NextVector2FromRectangle(Projectile.Hitbox), Vector2.Zero, new Color(0, 32, 19) * 0.6f, Main.rand.NextFloat(0.5f, 1f));
        }
