...
{
    public class GodGougerMiniPink : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.TintableDustLighted, Projectile.velocity * 0.2f, 100, Color.Pink, 1.2f);
                dust.noGravity = true;
                dust.fadeIn = 1.5f;
            }
