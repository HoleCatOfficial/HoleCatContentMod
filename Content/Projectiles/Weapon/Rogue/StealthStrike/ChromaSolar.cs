...
{
    public class ChromaSolar : ModProjectile, IHomingProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust Trail = Dust.NewDustPerfect(Projectile.Center, DustID.AncientLight, Vector2.Zero, 0, ColorLib.Solar, 1f);
