...
{
    public class ChromaVortex : ModProjectile, IHomingProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust Trail = Dust.NewDustPerfect(Projectile.Center, DustID.AncientLight, Vector2.Zero, 0, ColorLib.Vortex, 1f);
