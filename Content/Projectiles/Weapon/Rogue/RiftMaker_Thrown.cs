...
namespace DestroyerTest.Content.Projectiles.Weapon.Rogue
{
    public class RiftMaker_Thrown : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Opus.DrawProjectileShadowsRotating(Projectile, 8, ColorLib.Rift, 0.2f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Opus.RadialSpreadDustRandom(DustID.FireworksRGB, 13, Projectile.Center, 0, ColorLib.Rift, 1f, 2.4f);
        }
