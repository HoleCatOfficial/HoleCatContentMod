...
{
    public class FusionBlastDart : ModProjectile, IDrawPixelated, IHomingProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(DTUtils.CenteredDraw(Projectile, ColorLib.CelestialGradient with { A = 0 }));
            return false;
        }
        ...
        void IDrawPixelated.DrawPixelated(SpriteBatch spriteBatch)
        {
            ...
            DTTrail.DrawTrailPixelated(spriteBatch, BlendState.Additive, DTAssetLib.Streak(12, true).Value, Projectile.OldCenter().ToList(), Projectile.oldRot.ToList(), 12, ColorLib.CelestialGradient with { A = 0 }, trailOffset, 10);
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.Center, ColorLib.CelestialGradient.ToVector3() * 0.01f);
