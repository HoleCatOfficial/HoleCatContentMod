...
namespace DestroyerTest.Content.Projectiles.Weapon.Scepter.DiscordScepter.Power
{
    ...
    public class FusionFlameSpawner : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(6))
            {
                ...
                Vector2 directionToCenter = (center - spawnPosition).SafeNormalize(Vector2.Zero) * 5f;

                Projectile.NewProjectile(
                    Projectile.GetSource_FromThis(),
                    spawnPosition,
                    directionToCenter,
                    ModContent.ProjectileType<FusionFlame>(),
                    50,
                    2,
                    Projectile.owner
                );
