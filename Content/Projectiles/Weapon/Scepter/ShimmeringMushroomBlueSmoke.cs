...
{
    public class ShimmeringMushroomBlueSmoke : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //PRTLoader.NewParticle(PRTLoader.GetParticleID<SimpleParticle>(), Main.rand.NextVector2FromRectangle(Projectile.Hitbox), Vector2.Zero, ColorLib.TenebrisBlue * 0.6f, Main.rand.NextFloat(0.5f, 1f));
        }
