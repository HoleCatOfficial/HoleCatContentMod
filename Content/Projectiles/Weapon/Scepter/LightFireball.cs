...
namespace DestroyerTest.Content.Projectiles.Weapon.Scepter
{
    public class LightFireball : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Fire fire = new Fire();
            fire.PrepareFire(Projectile.Center, Vector2.Zero, Projectile.direction, 0.14f, ColorLib.SoulOfLightColor, 0.55f, 100, FireDrawMode.Additive, PixelLayer.AboveProjectiles);
