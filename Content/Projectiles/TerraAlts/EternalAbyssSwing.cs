...
{
	public class EternalAbyssSwing : ModProjectile
	{
        public SoundStyle SwingDown = new SoundStyle("DestroyerTest/Assets/Audio/LCSlash") with { PitchVariance = 1f };
        public SoundStyle SwingUp = new SoundStyle("DestroyerTest/Assets/Audio/LCSlash") with { PitchVariance = 1f };
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/EternalAbyss";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<AbyssWave>(),
                    Projectile.damage,
            ...
            if (CurrentAttack == AttackType.SwingDown)
            {
                ...
                Lighting.AddLight(player.Center, Color.DarkSlateBlue.ToVector3());
