...
{
	public class AetherAngelSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/AetherAngel";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<AngelWave>(),
                    Projectile.damage,
            ...
            if (CurrentAttack == AttackType.SwingDown)
            {
                ...
                Lighting.AddLight(player.Center, Color.Lavender.ToVector3());
