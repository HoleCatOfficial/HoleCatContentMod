...
{
	public class SunsetSaviorSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/SunsetSavior";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<SunsetWave>(),
                    Projectile.damage,
            ...
            if (CurrentAttack == AttackType.SwingDown)
            {
                ...
                Lighting.AddLight(player.Center, Color.PeachPuff.ToVector3());
