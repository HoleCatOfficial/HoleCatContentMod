...
{
	public class OmegasEdgeSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/OmegasEdge";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<OmegaWave>(),
                    Projectile.damage,
            ...
            if (CurrentAttack == AttackType.SwingDown)
            {
                ...
                Lighting.AddLight(player.Center, Color.SkyBlue.ToVector3());
