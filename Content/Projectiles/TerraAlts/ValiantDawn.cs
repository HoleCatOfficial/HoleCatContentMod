...
{
	public class ValiantDawnSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/ValiantDawn";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<DawnWave>(),
                    Projectile.damage,
            ...
            if (CurrentAttack == AttackType.SwingDown)
            {
                ...
                Lighting.AddLight(player.Center, Color.Goldenrod.ToVector3());
