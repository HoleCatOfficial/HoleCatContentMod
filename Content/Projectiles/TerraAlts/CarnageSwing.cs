...
{
	public class CarnageSwing : ModProjectile
	{
		...
		public override string Texture => "DestroyerTest/Content/MeleeWeapons/TerraAlts/Carnage";
        ...
        private void ExecuteStrike()
        {
            ...
            if (!hasFiredProjectile)
            {
                ...
                Projectile Wave = Projectile.NewProjectileDirect(
                    ...
                    ModContent.ProjectileType<CarnageWave>(),
                    Projectile.damage,
