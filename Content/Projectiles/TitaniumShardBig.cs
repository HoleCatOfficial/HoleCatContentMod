...
{
public class TitaniumShardBig : ModProjectile
		{
		...
		public override bool PreDraw(ref Color lightColor)
		{
            ...
            public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
            {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ModContent.ProjectileType<TitaniumShardSmall>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
                }
            }
