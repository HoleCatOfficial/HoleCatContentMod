...
namespace DestroyerTest.Content.Projectiles
{
    ...
    public class KnowledgeButterfly : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            PRTLoader.NewParticle(PRTLoader.GetParticleID<Boom2>(), Projectile.Center, Vector2.Zero, ColorLib.StellarColor, 0.4f);
        }
