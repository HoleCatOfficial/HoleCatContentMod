...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class PhosphorBronzeJavelinThrown : ModProjectile
	{
        public override string Texture => "DestroyerTest/Content/RogueItems/CopperTier/PhosphorBronzeJavelin";
