...
{
	public class TenebrisRocketProjectile_TileDestroy : ModProjectile
	{
		...
		public override void OnKill(int timeLeft) {
			...
			SoundEngine.PlaySound(new SoundStyle("DestroyerTest/Assets/Audio/Impacts/IceImpact", 3), Projectile.Center);
			...
			for (int j = 0; j < 20; j++) {
				Dust fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.FireworksRGB, 0f, 0f, 100, colorofLight, 3.5f);
            ...
            {
				int blastRadius = 7; // Rocket IV: 5, Mini Nuke Rocket II: 7
