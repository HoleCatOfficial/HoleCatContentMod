...
{
    public class ContenderSwordEnergy : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.LifeCrystal, Projectile.velocity * 0.2f, 100, default, 1.2f);
                dust.noGravity = true;
                dust.fadeIn = 1.5f;
            }
        ...
        public override bool OnTileCollide(Vector2 oldVelocity) {
            ...
            for (int i = 0; i < 10; i++)
            {
                Dust dust = Dust.NewDustPerfect(Projectile.position, DustID.LifeCrystal, oldVelocity.RotatedByRandom(MathHelper.PiOver4) * 0.5f, 150, default, 1.5f);
                dust.noGravity = true;
                dust.fadeIn = 1.5f;
            }
