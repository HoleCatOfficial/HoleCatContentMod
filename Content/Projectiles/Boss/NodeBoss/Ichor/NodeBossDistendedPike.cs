...
namespace DestroyerTest.Content.Projectiles.Boss.NodeBoss.Ichor
{
    public class NodeBossDistendedPike : ModProjectile
    {
        ...
        private void DoDashingPhase(Player target)
        {
            ...
            if (Timer == 1f) // first tick of dashing phase
            {
                ...
                Projectile.velocity = direction * 38f;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Ring.Prepare(Projectile.Center, Vector2.Zero, ColorLib.IchorCrystalColorMap, 0.06f, 0.01f, 1f);
            ParticleEngine.Particles.Add(Ring);

            Opus.RadialSpreadProjectile(ModContent.ProjectileType<IchorNodeCrystal2>(), 5, Projectile.Center, Projectile.damage / 2, 7, 30, offset: Projectile.rotation);
        }
    ...
    public class NodeBossDistendedPike2 : ModProjectile
    {
        public override string Texture => "DestroyerTest/Content/Projectiles/Boss/NodeBoss/Ichor/NodeBossDistendedPike";
        private enum AIState
        {
            Slowing,
            Dashing
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Main.EntitySpriteDraw(DTAssetLib.NodeBossPikeOutline.Value, Projectile.Center - Main.screenPosition, null, ColorLib.IchorCrystalGradient * Projectile.Opacity, Projectile.rotation, new Vector2(DTAssetLib.NodeBossPikeOutline.Value.Width / 2, DTAssetLib.NodeBossPikeOutline.Value.Height / 2), Projectile.scale, SpriteEffects.None, 0);
            Main.EntitySpriteDraw(TextureAssets.Projectile[Projectile.type].Value, Projectile.Center - Main.screenPosition, null, Color.White * Projectile.Opacity, Projectile.rotation, new Vector2(Projectile.width / 2, Projectile.height / 2), Projectile.scale, SpriteEffects.None, 0);
            return false;
        }
    }
}