...
{
    public class SoulSpark : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDust(Projectile.position, Projectile.Hitbox.Width, Projectile.Hitbox.Height, DustID.FireworksRGB, Main.rand.NextFloat(-1, 1.1f), Main.rand.NextFloat(-1, 1.1f), 0, ColorLib.Soul, 0.5f);
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            for (int u = 0; u < 6; u++)
            {
                Dust.NewDust(Projectile.position, Projectile.Hitbox.Width, Projectile.Hitbox.Height, DustID.FireworksRGB, Main.rand.NextFloat(-4f, 4f), Main.rand.NextFloat(-4f, 4f), 0, ColorLib.Soul, 0.3f);
            }
        }
    ...
    public class SoulSpark_NoHoming : ModProjectile
    {
        public override string Texture => DTUtils.NoTexture;
