...
{
    public class LightLance : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
		{
            ...
            DTTrail.DrawTrail(spriteBatch, DTAssetLib.Streak(7).Value, TrailPositions, TrailRotations, 35, ColorLib.Soul, trailOffset);
        ...
        {
            Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, ModContent.DustType<ColorableNeonDust>(), Projectile.velocity.X * 0.7f, Projectile.velocity.Y * 0.7f, 0, ColorLib.Soul, 1);
            ...
            for (int i = 0; i < numProjectiles; i++)
            {
                ...
                Projectile.NewProjectile(
                    ...
                    Projectile.Center,
                    velocity,
                    ModContent.ProjectileType<LightDart>(),
                    Projectile.damage / 2,
