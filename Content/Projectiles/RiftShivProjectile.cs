...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class RiftShivProjectile : ModProjectile
	{
		...
		public float CollisionWidth => 102f * Projectile.scale;
		...
		public override void AI() {
			...
			//const float DoubleRot = MathHelper.PiOver2 * 2;

			// Point towards where it is moving, applied offset for top right of the sprite respecting spriteDirection
			//Projectile.rotation = Projectile.velocity.ToRotation() - DoubleRot * Projectile.spriteDirection;
