...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class CunifeJavelinThrown : ModProjectile
	{
        public override string Texture => "DestroyerTest/Content/RogueItems/IronTier/CunifeJavelin";
		...
		public override bool PreDraw(ref Color lightColor)
		{
            ...
            Vector2 offset = new Vector2(7.0f, 7.0f).RotatedBy(Projectile.rotation);
            Vector2 offsetpos = Projectile.Center + offset - Main.screenPosition;
