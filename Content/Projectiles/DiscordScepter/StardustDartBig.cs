	...
	public class StardustDartBig : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			for (int i = 0; i < 8; i++)
			{
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ModContent.ProjectileType<StardustDartSmall>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
			}
		}
