...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class TrueLaevateinnArc : ModProjectile
	{
		...
		public override void AI() {
			...
			float scaleMulti = 4.0f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
			...
			Projectile.scale *= Projectile.ai[2] / 2; // Set the scale of the projectile to the scale of the item.
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			ParticleOrchestrator.RequestParticleSpawn(clientOnly: false, ParticleOrchestraType.Excalibur,
				new ParticleOrchestraSettings { PositionInWorld = Main.rand.NextVector2FromRectangle(target.Hitbox), UniqueInfoPiece = 1 },
				Projectile.owner);
