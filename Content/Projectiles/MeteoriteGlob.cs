...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class MeteoriteGlob : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			...
			if (Projectile.soundDelay == 0) {
				...
				SoundStyle impactSound = new SoundStyle("DestroyerTest/Assets/Audio/MeteoriteGlobExplode") with {
					Volume = 0.7f,
					PitchVariance = 0.5f,
				};
		...
		public override void OnKill(int timeLeft) {
			...
			if (Projectile.owner == Main.myPlayer && !IsChild) {
				for (int i = 0; i < 5; i++) {
					...
					(child.ModProjectile as MeteoriteGlob).IsChild = true;
            ...
            SoundStyle BurstSound = new SoundStyle("DestroyerTest/Assets/Audio/MeteoriteGlobExplode") with {
					Volume = 0.7f,
					PitchVariance = 0.5f,
				};
