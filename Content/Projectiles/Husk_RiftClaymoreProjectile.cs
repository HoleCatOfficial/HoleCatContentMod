...
namespace DestroyerTest.Content.Projectiles
{
	...
	public class Husk_RiftClaymoreProjectile : ModProjectile
	{
        SoundStyle Swing = new SoundStyle($"DestroyerTest/Assets/Audio/AlloySwing") with {
			Volume = 1.0f, 
    		Pitch = 0.0f, 
    		PitchVariance = 0.5f, 
		...
		{
			Projectile.width = 106; // Hitbox width of projectile
