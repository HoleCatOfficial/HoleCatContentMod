...
{
    [AutoloadGlowmask]
    public class TenebrousSlingerPet : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            Main.projPet[Type] = true;
        }
        public SoundStyle TP = new SoundStyle("DestroyerTest/Assets/Audio/TenebrisSlinger/TenebrisSlingerArrowImpact", 4)
        {
            PitchRange = (0.5f, 1f),
            MaxInstances = 0
        };
        ...
        public override void AI()
        {
            ...
            if (player.dead || !player.active)
                player.ClearBuff(ModContent.BuffType<TenebrousSlingerPetBuff>());

            if (player.HasBuff(ModContent.BuffType<TenebrousSlingerPetBuff>()))
                Projectile.timeLeft = 2;
