...
namespace DestroyerTest.Content.RiftBiome.RiftDesertResources
{
	...
	public class Tile_RiftSilt : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileID.Sets.FallingBlockProjectile[Type] = new TileID.Sets.FallingBlockProjectileInfo(ModContent.ProjectileType<RiftSiltBallFallingProjectile>(), 10); // Tells which falling projectile to spawn when the tile should fall.
