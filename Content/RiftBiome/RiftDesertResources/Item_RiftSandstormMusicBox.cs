...
namespace DestroyerTest.Content.RiftBiome.RiftDesertResources
{
	public class Item_RiftSandstormMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/RiftSandstorm"), ModContent.ItemType<Item_RiftSandstormMusicBox>(), ModContent.TileType<Tile_RiftSandstormMusicBox>());
		}
