...
{
    public class Tile_RiftDesertUndergroundMusicBox : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(255, 155, 0), Language.GetText("ItemName.MusicBox"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Item_RiftDesertUndergroundMusicBox>();
        }
