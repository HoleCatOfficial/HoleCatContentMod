...
namespace DestroyerTest.Content.CheatItems
{
    ...
    public class TenebrousConstructSummoner : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return !NPC.AnyNPCs(ModContent.NPCType<TenebrousConstructSpawn>()) && !NPC.AnyNPCs(ModContent.NPCType<TenebrousConstruct>());
        }
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                int type = ModContent.NPCType<TenebrousConstructSpawn>();
