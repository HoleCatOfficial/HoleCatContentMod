...
namespace DestroyerTest.Content.RiftArsenalNoCharge
{
	...
	public class Husk_RiftScabbard : ModItem
	{
        ...
        {
            Item.NewItem(player.GetSource_OpenItem(Type), player.position, ModContent.ItemType<RiftScabbard>());
            Item.TurnToAir();
