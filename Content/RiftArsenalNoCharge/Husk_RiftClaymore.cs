...
namespace DestroyerTest.Content.RiftArsenalNoCharge
{
	...
	public class Husk_RiftClaymore : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<Husk_RiftClaymoreProjectile>(); // The sword as a projectile
		}
        ...
        {
            Item.NewItem(player.GetSource_OpenItem(Type), player.position, ModContent.ItemType<RiftClaymore>());
            Item.TurnToAir();
