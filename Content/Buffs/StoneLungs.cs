...
namespace DestroyerTest.Content.Buffs
{
	...
	public class StoneLungs : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			player.GetModPlayer<StoneLungsPlayer>().StoneLungsEffects = true;
		}
	}

	public class StoneLungsPlayer : ModPlayer
	{
        
		// Flag checking when life regen debuff should be activated
		public bool StoneLungsEffects;

		public override void ResetEffects() {
			StoneLungsEffects = false;
		}
		...
		public override void UpdateBadLifeRegen() {
            ...
            if (LungShot.BuffTimeInt >= 4000 && !StoneLungsEffects) 
            {

            }
			if (StoneLungsEffects) {
