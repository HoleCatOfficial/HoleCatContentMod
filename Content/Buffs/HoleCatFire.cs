...
namespace DestroyerTest.Content.Buffs
{
	...
	public class HoleCatFire : ModBuff
	{
		...
		{
			player.GetModPlayer<HCFPlayer>().lifeRegenDebuff = true;
		}
		
		public override void Update(NPC target, ref int buffIndex)
		{
			if (target.TryGetGlobalNPC<HCFTarget>(out var modNPC))
			{
	...
	public class HCFPlayer : ModPlayer
	{
