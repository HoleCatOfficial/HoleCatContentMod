...
{
    public class HaepiensInferno : ModBuff
    {
        ...
        public override void Update(NPC target, ref int buffIndex) {
            if (target.TryGetGlobalNPC<HITarget>(out var modNPC)) {
    ...
    public class HITarget : GlobalNPC
    {
        ...
        public override void UpdateLifeRegen(NPC npc, ref int damage) {
            if (lifeRegenDebuff) {
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    int dustIndex = Dust.NewDust(spawnPosition, 0, 0, DustID.FlameBurst, velocity.X, velocity.Y, 0, default, 1.5f);
