...
{
    public class WinterWonderland : ModItem
        {
            SoundStyle Jab = new SoundStyle($"DestroyerTest/Assets/Audio/WW_Jab") {
				Volume = 1.0f, 
				Pitch = 0.0f, 
				PitchVariance = 0.5f, 
			}; 
            ...
            public override void SetDefaults() {
                ...
                Item.shoot = ModContent.ProjectileType<WinterWonderlandJabProjectile>(); // The projectile that is fired from this weapon
            }
            ...
            public override bool CanUseItem(Player player) {
                ...
                if (player.altFunctionUse == 2) {
                        ...
                        Item.UseSound = Jab;
                        Item.shoot = ModContent.ProjectileType<WinterWonderlandSwingProjectile>(); // The projectile that is fired from this weapon
