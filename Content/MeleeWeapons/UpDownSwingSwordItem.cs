...
namespace DestroyerTest.Content.MeleeWeapons
{
	...
	public class UpDownSwingSwordItem : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<UpDownSwingSword>(); // The sword as a projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ItemID.ShimmerflyinaBottle, 2)
