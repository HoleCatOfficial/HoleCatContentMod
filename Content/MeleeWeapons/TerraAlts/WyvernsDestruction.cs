...
namespace DestroyerTest.Content.MeleeWeapons.TerraAlts
{
	...
	public class WyvernsDestruction : ModItem
    {
        ...
        {
            Item.width = 76; // The item texture's width.
            Item.height = 86; // The item texture's height.
            ...
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<WyvernsDestructionSwing>();
        }
