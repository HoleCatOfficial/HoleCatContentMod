...
namespace DestroyerTest.Content.MeleeWeapons.TerraAlts
{
	...
	public class OmegasEdge : ModItem
    {
        ...
        {
            Item.width = 74; // The item texture's width.
            Item.height = 82; // The item texture's height.
            ...
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<OmegasEdgeSwing>();
        }
