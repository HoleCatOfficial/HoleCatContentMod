...
{
    public class FrigidHalberd : ModItem
        {
            ...
            public override void SetDefaults() {
                ...
                Item.shoot = ModContent.ProjectileType<FrigidHalberdJabProjectile>(); // The projectile that is fired from this weapon
            }
            ...
            public override bool CanUseItem(Player player) {
                ...
                if (player.altFunctionUse == 2) {
                        ...
                        Item.UseSound = Jab;
                        Item.shoot = ModContent.ProjectileType<FrigidHalberdSwingProjectile>(); // The projectile that is fired from this weapon
