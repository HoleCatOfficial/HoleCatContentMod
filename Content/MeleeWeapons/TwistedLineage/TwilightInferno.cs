...
namespace DestroyerTest.Content.MeleeWeapons.TwistedLineage
{
	public class TwilightInferno : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.damage = 58; // The damage of your sword, this is dynamically adjusted in the projectile code.
			...
			Item.shoot = ModContent.ProjectileType<TwilightInfernoProjectile>(); // The sword as a projectile
		}
    }
} 