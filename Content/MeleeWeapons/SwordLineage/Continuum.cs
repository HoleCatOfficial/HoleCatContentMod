...
namespace DestroyerTest.Content.MeleeWeapons.SwordLineage
{
	...
	public class Continuum : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.noMelee = true;
			Item.shoot = ModContent.ProjectileType<ContinuumSwing>();
		}
        ...
        public override void AddRecipes()
        {
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<ConstitutionT2_Crimtane>(), 1)
            ...
            CreateRecipe()
				...
				.AddIngredient(ItemID.SoulofFright, 5)
				.AddIngredient(ItemID.SoulofSight, 5)
				.AddIngredient(ModContent.ItemType<ConstitutionT2_Demonite>(), 1)
				.AddTile(TileID.MythrilAnvil) // Use the correct TileID name if 16 is Anvils
            .Register();
		}	
	}
