...
namespace DestroyerTest.Content.MeleeWeapons.SwordLineage
{
	...
	public class Conclusion : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.noMelee = true;
			Item.shoot = ModContent.ProjectileType<ConclusionSwing>();
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<StellarFlames>(), 16);
			recipe.AddIngredient(ModContent.ItemType<Corrolary>(), 1);
			recipe.AddIngredient(ModContent.ItemType<RogueItems.TemporalLance>(), 1);

			if (ModLoader.TryGetMod("CalamityMod", out Mod Calamity))
			{
				int ModdedNecessity2 = Calamity.Find<ModItem>("GalacticaSingularity").Type;
				recipe.AddIngredient(ModdedNecessity2, 2);
			}
			recipe.Register();
