...
namespace DestroyerTest.Content.MeleeWeapons
{
    ...
    public class TrueSoulEdgeProjection : ModProjectile
    {
	...
	public class TrueSoulEdge : ModItem
	{
        public override void SetStaticDefaults()
        {
        }
        public override void SetDefaults() {
			...
			Item.damage = 140; // The damage your item deals.
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            int proj = Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<TrueSoulEdgeProjection>(), damage, knockback, player.whoAmI);
