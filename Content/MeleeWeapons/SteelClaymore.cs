...
namespace DestroyerTest.Content.MeleeWeapons
{
	...
	public class SteelClaymore : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<SteelClaymoreSwing>(); // The sword as a projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<Steel>(30)
                .AddIngredient<OrangeCloth>(3)
