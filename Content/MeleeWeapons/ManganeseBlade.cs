...
namespace DestroyerTest.Content.MeleeWeapons
{
	...
	public class ManganeseBlade : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<ManganeseBladeSwing>(); // The sword as a projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<SturdyTang>(1)
				.AddIngredient<ManganeseBronze>(6)
