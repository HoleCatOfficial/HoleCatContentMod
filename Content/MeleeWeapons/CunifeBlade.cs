...
namespace DestroyerTest.Content.MeleeWeapons
{
	...
	public class CunifeBlade : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 12; // The damage of your sword, this is dynamically adjusted in the projectile code.
			Item.DamageType = DamageClass.Melee; // Deals melee damage
			Item.noMelee = true;  // This makes sure the item does not deal damage from the swinging animation
			Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand

			// Projectile Properties
			Item.shoot = ModContent.ProjectileType<CunifeBladeSwing>(); // The sword as a projectile
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<CunifeBar>(6)
                .AddIngredient<HornedTang>(1)
                .AddIngredient(ItemID.TinBar, 2)
                .AddIngredient<BrownCloth>(3)
