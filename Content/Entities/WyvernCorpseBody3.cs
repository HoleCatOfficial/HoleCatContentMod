...
{
    public class WyvernCorpseBody3 : ModNPC
    {
        ...
        public void SetTex()
        {
            if (!flag)
            {
                ...
                {
                    /*
                    texture = NPC.GetMasoTexture("DestroyerTest/Content/Entities/MasoMode", "WyvernCorpseBody3");
                    Glowtexture = NPC.GetMasoTexture("DestroyerTest/Content/Entities/MasoMode", "WyvernCorpseBody3");
                    */
