...
{
	public class CappedTang : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.width = 30;
			Item.height = 30;
			Item.value = 1500; // The cost of the item in copper coins. (1 = 1 copper, 100 = 1 silver, 1000 = 1 gold, 10000 = 1 platinum)
			Item.maxStack = 1;
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<CappedMold>(1)
				.AddIngredient<PhosphorBronze>(5)
                .AddIngredient<BabylonianPlates>(2)
