...
{
	public class ScepterData : ModItem
	{
        ...
        public override bool? UseItem(Player player) {
            ...
            CombatText.NewText(player.Hitbox, ColorLib.Rift, "This a configuration of Data for making Scepters.");
            return true;
        }
