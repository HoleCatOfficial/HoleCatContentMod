...
namespace DetroyerTest.Content.PARADISEMANAGEMENT
{
	public class ParadiseStyle : ModSurfaceBackgroundStyle
	{
		...
		public override int ChooseFarTexture() {
			return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/VanOcean5");
		}
