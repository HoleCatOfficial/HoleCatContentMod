...
namespace DestroyerTest.Content.SummonItems
{
	...
	public class EyeSword_Buff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<EyeSword>()] > 0) {
	...
	public class CursedScabbard : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<EyeSword_Buff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<EyeSword>(); // This item creates the minion projectile
		}
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
            ...
            {
                ModContent.ProjectileType<EyeSword>(),
		...
		public override void AddRecipes() {
			CreateRecipe()
                ...
                .AddIngredient<SkyBlueCloth>(8)
                .AddIngredient<NavalBrass>(4)
	...
	public class EyeSword : ModProjectile
	{
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<EyeSword_Buff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<EyeSword_Buff>())) {
		...
		private void GeneralBehavior(Player owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition) {
			...
			Vector2 center = owner.Center; // The point to orbit around
			...
			vectorToIdlePosition = center - Projectile.Center;
		...
		private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, float distanceToIdlePosition, Vector2 vectorToIdlePosition) {
			...
			if (foundTarget) {
				...
				if (distanceFromTarget > 40f) {
					...
					// Adjust the projectile's velocity to turn towards the target angle
					...
					// Update the projectile's rotation to face the target
