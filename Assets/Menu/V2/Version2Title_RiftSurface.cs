...
namespace DestroyerTest.Assets.Menu.V2
{
	public class Version2Title_RiftSurface : ModMenu
	{
		...
		*/
		...
		public override ModSurfaceBackgroundStyle MenuBackgroundStyle => ModContent.GetInstance<RiftSurfaceBackgroundStyle>();

		public override string DisplayName => "Update 2.1.4: Rift (Surface)";
